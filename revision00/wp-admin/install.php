...
$wpdb->query("INSERT INTO $wpdb->links (link_url, link_name, link_category, link_rss) VALUES ('http://steamedpenguin.com/', 'Samir', 1, 'http://www.steamedpenguin.com/journal/atom.php');");
...
// Default comment
$wpdb->query("INSERT INTO $wpdb->comments (comment_post_ID, comment_author, comment_author_email, comment_author_url, comment_author_IP, comment_date, comment_date_gmt, comment_content) VALUES ('1', '".addslashes(__('Mrs. SteamPress'))."', '', 'http://steamedpenguin.com/projects/steampress/', '127.0.0.1', '$now', '$now_gmt', '".addslashes(__('Hi, this is a comment.<br />To delete a comment, just log in, and view the posts\' comments, there you will have the option to edit or delete them.'))."')");
...
$message_headers = 'From: ' . stripslashes($_POST['weblog_title']) . ' <steampress@' . $_SERVER['SERVER_NAME'] . '>';
...
?>
<p id="footer"><?php _e('<a href="http://steamedpenguin.com/projects/steampress/">SteamPress</a>, a light, extensible, publishing platform.'); ?></p>
</body>
</html>
