...
$steampress_queries="CREATE TABLE $steampressdb->categories (
...
CREATE TABLE $steampressdb->comments (
...
CREATE TABLE $steampressdb->linkcategories (
...
CREATE TABLE $steampressdb->links (
...
CREATE TABLE $steampressdb->options (
...
CREATE TABLE $steampressdb->post2cat (
...
CREATE TABLE $steampressdb->postmeta (
...
CREATE TABLE $steampressdb->posts (
...
CREATE TABLE $steampressdb->users (
...
function populate_options()
{
	...
	$guessurl = preg_replace('|/steampress-admin/.*|i', '', 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']);
	...
	add_option('fileupload_realpath', ABSPATH . 'steampress-content');
	add_option('fileupload_url', get_option('siteurl') . '/steampress-content');
	...
	add_option('weblogs_xml_url', 'http://static.steampress.org/changes.xml');
	...
	$unusedoptions = array ('blodotgsping_url', 'bodyterminator', 'emailtestonly', 'phoneemail_separator', 'smilies_directory', 'subjectprefix', 'use_bbcode', 'use_blodotgsping', 'use_phoneemail', 'use_weblogsping', 'weblogs_cache_file', 'use_preview', 'use_htmltrans', 'smilies_directory', 'rss_language', 'fileupload_allowedusers', 'use_phoneemail', 'default_post_status', 'default_post_category', 'archive_mode', 'time_difference', 'links_minadminlevel', 'links_use_adminlevels', 'links_rating_type', 'links_rating_char', 'links_rating_ignore_zero', 'links_rating_single_image', 'links_rating_image0', 'links_rating_image1', 'links_rating_image2', 'links_rating_image3', 'links_rating_image4', 'links_rating_image5', 'links_rating_image6', 'links_rating_image7', 'links_rating_image8', 'links_rating_image9', 'weblogs_cacheminutes', 'comment_allowed_tags', 'search_engine_friendly_urls', 'default_geourl_lat', 'default_geourl_lon', 'use_default_geourl');
	...
	{
		$steampressdb->query("UPDATE $steampressdb->options SET `autoload` = 'no' WHERE option_name = '$fatoption'");
	}
}
?>