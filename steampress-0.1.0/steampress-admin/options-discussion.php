...
<fieldset class="options">
    ...
    <p><?php _e('When a comment contains any of these words in its content, name, URI, e-mail, or IP, hold it in the moderation queue: (Separate multiple words with new lines.) <a href="http://codex.steampress.org/Spam_Words">Common spam words</a>.') ?></p>
		<p> 
