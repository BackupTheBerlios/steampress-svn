...
$steampressvarstoreset = array('action','redirect','profile','user');
...
case 'update':
	...
	$result = $steampressdb->query("UPDATE $steampressdb->users SET user_firstname='$newuser_firstname', $updatepassword user_lastname='$newuser_lastname', user_nickname='$newuser_nickname', user_icq='$newuser_icq', user_email='$newuser_email', user_url='$newuser_url', user_aim='$newuser_aim', user_msn='$newuser_msn', user_yim='$newuser_yim', user_idmode='$newuser_idmode', user_description = '$user_description', user_nicename = '$newuser_nicename' WHERE ID = $user_ID");
...
<form name="profile" id="profile" action="profile.php" method="post">
	...
	<tr>
		...
		<td>
			...
			<option value="nickname"<?php if ($profiledata->user_idmode == 'nickname')
			{
				echo ' selected="selected"';
			}
			?>><?php echo $profiledata->user_nickname ?></option>
			<option value="login"<?php if ($profiledata->user_idmode=="login")
			{
				echo ' selected="selected"';
			}
			?>><?php echo $profiledata->user_login ?></option>
			<option value="firstname"<?php if ($profiledata->user_idmode=="firstname")
			{
				echo ' selected="selected"';
			}
			?>><?php echo $profiledata->user_firstname ?></option>
			<option value="lastname"<?php if ($profiledata->user_idmode=="lastname")
			{
				echo ' selected="selected"';
			}
			?>><?php echo $profiledata->user_lastname ?></option>
			<option value="namefl"<?php if ($profiledata->user_idmode=="namefl")
			{
				echo ' selected="selected"';
			}
			?>><?php echo $profiledata->user_firstname." ".$profiledata->user_lastname ?></option>
			<option value="namelf"<?php if ($profiledata->user_idmode=="namelf")
			{
				echo ' selected="selected"';
			}
