...
if ( isset($_POST) )
{
	if ( isset($_POST['permalink_structure']) )
	{
		...
		$steampress_rewrite->set_permalink_structure($permalink_structure);
	}
	...
	if ( isset($_POST['category_base']) )
	{
		...
		$steampress_rewrite->set_category_base($category_base);
	}
}
...
<div class="wrap"> 
	...
	<p><?php _e('By default SteamPress uses web URIs which have question marks and lots of numbers in them, however SteamPress offers you the ability to create a custom URI structure for your permalinks and archives. This can improve the aesthetics, usability, and longevity of your links. A <a href="http://codex.steampress.org/Permalink_Structure">number of tags are available</a>, and here are some examples to get you started.'); ?></p>
...
{
?>
<p><?php _e('If your <code>.htaccess</code> was <a href="http://codex.steampress.org/Make_a_Directory_Writable">writable</a> we could do this automatically, but it isn&#8217;t so these are the mod_rewrite rules you should have in your <code>.htaccess</code> file. Click in the field and press <kbd>CTRL + a</kbd> to select all.') ?></p>
<form action="options-permalink.php" method="post">
	 <p>
<textarea rows="5" style="width: 98%;" name="rules"><?php echo $steampress_rewrite->mod_rewrite_rules(); ?>
</textarea>
		</p>
<?php
}
