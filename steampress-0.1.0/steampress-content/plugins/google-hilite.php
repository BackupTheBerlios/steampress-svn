...
Plugin URI: http://steampress.org
Description: When someone is referred from a search engine like Google, Yahoo, or SteamPress' own, the terms they search for are highlighted with this plugin. Packaged by <a href="http://photomatt.net/">Matt</a>.
Version: 1.2
Author: Ryan Boren
...
{
	$search_engines = array('steampress', 'google', 'lycos', 'yahoo');
...
add_action('steampress_head', 'hilite_head');
