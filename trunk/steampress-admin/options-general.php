...
<?php _e('In a few words, explain what this weblog is about.') ?></td> 
		...
		<tr valign="top"> 
		<th scope="row"><?php _e('SteamPress address (URI):') ?></th> 
		...
		<tr valign="top">
			...
			<td><input name="home" type="text" id="home" value="<?php form_option('home'); ?>" size="40" class="code" /><br /><?php _e('If you want your blog homepage to be different than the directory you installed SteamPress in, enter that address here. '); ?></td>
			</tr>
		<tr valign="top"> 
...
{
	if ($day_index == get_settings('start_of_week'))
	{
