...
$steampressvarstoreset = array('action','cat');
...
case 'addcat':
	...
	$cat_ID = $steampressdb->get_var("SELECT cat_ID FROM $steampressdb->categories ORDER BY cat_ID DESC LIMIT 1") + 1;
	$category_nicename = sanitize_title($cat_name, $cat_ID);
	$category_description = $_POST['category_description'];
	$cat = intval($_POST['cat']);

	$steampressdb->query("INSERT INTO $steampressdb->categories (cat_ID, cat_name, category_nicename, category_description, category_parent) VALUES ('0', '$cat_name', '$category_nicename', '$category_description', '$cat')");
...
case 'Delete':
	...
	$category = $steampressdb->get_row("SELECT * FROM $steampressdb->categories WHERE cat_ID = '$cat_ID'");
	...
	$steampressdb->query("DELETE FROM $steampressdb->categories WHERE cat_ID = '$cat_ID'");
	$steampressdb->query("UPDATE $steampressdb->categories SET category_parent = '$cat_parent' WHERE category_parent = '$cat_ID'");
	$steampressdb->query("UPDATE $steampressdb->post2cat SET category_id='1' WHERE category_id='$cat_ID'");
...
<div class="wrap">
	...
	<form name="editcat" action="categories.php" method="post">
		...
		<?php steampress_dropdown_cats($category->cat_ID, $category->category_parent); ?>
		</select>
		</p>
...
case 'editedcat':
	...
	$steampressdb->query("UPDATE $steampressdb->categories SET cat_name = '$cat_name', category_nicename = '$category_nicename', category_description = '$category_description', category_parent = '$cat' WHERE cat_ID = '$cat_ID'");
...
<div class="wrap">
	...
	<form name="addcat" id="addcat" action="categories.php" method="post">
		...
		<?php steampress_dropdown_cats(0); ?>
		</select></p>
