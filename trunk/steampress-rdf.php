...
<channel rdf:about="<?php bloginfo_rss("url") ?>">
	...
	<admin:generatorAgent rdf:resource="http://wordpress.org/?v=<?php echo $steampress_version ?>"/>
	...
	<items>
		...
		<?php $steampress_items[] = $row; $items_count++; if (($items_count == get_settings('posts_per_rss')) && empty($m)) { break; } } } ?>
		</rdf:Seq>
	</items>
</channel>
