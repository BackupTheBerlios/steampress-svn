...
if ( isset($_POST) ) {
	if ( isset($_POST['permalink_structure']) ) {
		...
		$sp_rewrite->set_permalink_structure($permalink_structure);
	}
	...
	if ( isset($_POST['category_base']) ) {
		...
		$sp_rewrite->set_category_base($category_base);
	}
}
...
<?php if ( $permalink_structure && !$usingpi && !$writable ) : ?>
  <p><?php _e('If your <code>.htaccess</code> was <a href="http://codex.steampress.berlios.de/Make_a_Directory_Writable">writable</a> we could do this automatically, but it isn&#8217;t so these are the mod_rewrite rules you should have in your <code>.htaccess</code> file. Click in the field and press <kbd>CTRL + a</kbd> to select all.') ?></p>
<form action="options-permalink.php" method="post">
   <p>
<textarea rows="5" style="width: 98%;" name="rules"><?php echo $sp_rewrite->mod_rewrite_rules(); ?>
</textarea>
    </p>
</form>
<?php endif; ?>
