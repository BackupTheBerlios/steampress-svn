...
<div id="poststuff">
    ...
    <fieldset id="categorydiv">
      <legend><a href="http://steampress.berlios.de/docs/reference/post/#category" title="<?php _e('Help on categories') ?>"><?php _e('Categories') ?></a></legend> 
...
?>
<textarea rows="<?php echo $rows; ?>" name="content" tabindex="4" id="content"><?php echo $content ?></textarea>
</fieldset>

<input type="hidden" name="post_pingback" value="1" id="post_pingback" />

<p><label for="trackback"><?php _e('Trackback URIs') ?> </label> (Separate multiple <abbr title="Universal Resource Identifier">URI</abbr>s with spaces.)<br />
