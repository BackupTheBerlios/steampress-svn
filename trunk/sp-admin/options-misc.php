...
<form name="miscoptions" method="post" action="options.php"> 
	...
	<input type="hidden" name="page_options" value="'use_linksupdate','weblogs_xml_url','links_updated_date_format','links_recently_updated_prepend','links_recently_updated_append'" /> 
	...
	<?php __('Recommended: <code>http://static.steampress.berlios.de/changes.xml</code>') ?>
