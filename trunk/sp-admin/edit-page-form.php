...
?>
<div><textarea rows="<?php echo $rows; ?>" name="content" tabindex="4" id="content"><?php echo $content ?></textarea></div>
</fieldset>

<p class="submit">
  <input name="savepage" type="submit" id="savepage" tabindex="6" value="<?php $post_ID ? _e('Edit Page') :_e('Create New Page') ?> &raquo;" /> 
  <input name="referredby" type="hidden" id="referredby" value="<?php if (isset($_SERVER['HTTP_REFERER'])) echo sp_specialchars($_SERVER['HTTP_REFERER']); ?>" />
</p>
