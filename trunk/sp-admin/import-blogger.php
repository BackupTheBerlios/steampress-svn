...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	<title>Blogger to SteamPress - Converting...</title>
	<link rel="stylesheet" href="sp-admin.css" type="text/css">
</head>
<body>
<div class="wrap">
<h1>Blogger to <img src="../sp-images/wpminilogo.png" width="50" height="50" border="0" alt="SteamPress" align="top" /></h1>
...
<ul>
	...
	for($bgy=1999; $bgy<=(date('Y')); $bgy++) {
		...
		$archivefile = "../$bgy"."_"."$bgmm"."_01_steampress.php";
		...
		if (file_exists($archivefile)) {
			...
			$posts = explode('<steampresspost>', $archive);
			...
			$user = $spdb->get_row("SELECT * FROM $spdb->users WHERE user_login = '$post_author'");
			if (!$user) { // seems s/he's not, so let's register
				...
				$user_email = addslashes('user@steampress.berlios.de');
				$user_url = addslashes('');
				$user_joindate = addslashes($user_joindate);
				$result = $spdb->query("
				INSERT INTO $spdb->users (
					user_login,
					user_pass,
					user_nickname,
					user_email,
			...
			$post_author_ID = $spdb->get_var("SELECT ID FROM $spdb->users WHERE user_login = '$post_author'");
			...
			$dupcheck = $spdb->get_results("SELECT ID,post_date,post_title FROM $spdb->posts WHERE post_date='$post_date' AND post_title='$post_title' LIMIT 1",ARRAY_A);
			if ($dupcheck[0]['ID']) {
	...
	/* we've still got a bug that adds some empty posts with the date 0000-00-00 00:00:00
	   here's the bugfix: */
	$result = $spdb->query("DELETE FROM $spdb->posts WHERE post_date=\"0000-00-00 00:00:00\"");
...
<p>&nbsp;</p>
<p>Completed Blogger to SteamPress import!</p>
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	<title>Blogger to SteamPress Import Utility</title>
	<link rel="stylesheet" href="sp-admin.css" type="text/css">
</head>
...
<div class="wrap">
<h1>Blogger to <img src="../sp-images/wpminilogo.png" width="50" height="50" border="0" alt="SteamPress" align="top" /></h1>
<p>This is a basic Blogger to SteamPress import script.</p>
<p>What it does:</p>
<ul>
...
<h2>First step: Install SteamPress</h2>
<p>Install the SteamPress blog as explained in the <a href="../readme.html">read me</a>, then immediately come back here.</p>

<h3>Second step: let's play with Blogger</h3>
<p>Log into your Blogger account.<br />
Go to the Settings, and make Blogger publish your files in the directory where your SteamPress resides. Change the Date/Time format to be mm/dd/yyyy hh:mm:ss AM/PM (the first choice in the dropdown menu). In Archives: set the frequency to 'monthly' and the archive filename to 'steampress.php' (without the quotes), set the ftp archive path to make Blogger publish the archives in your SteamPress directory. Click 'save changes'.<br />
Go to the Templates. Replace your existing template with this line (copy and paste):
<blockquote>&lt;Blogger>&lt;steampresspost>&lt;$BlogItemDateTime$>|||&lt;$BlogItemAuthorNickname$>|||&lt;$BlogItemBody$>|||&lt;$BlogItemNumber$>|||&lt;$BlogItemSubject$>&lt;/Blogger></blockquote>
Go to the Archives, and click 'republish all'.<br />
Check in your FTP that you've got the archive files published. They should look like this example: <code>2001_10_01_steampress.php</code>. If they aren't there, redo the republish process.</p>
