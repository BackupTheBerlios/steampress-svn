...
if (isset($user_ID) && ('' != intval($user_ID))) {
    $posts = $spdb->get_results("SELECT * FROM $spdb->posts WHERE post_status = 'static' AND post_author = $user_ID");
} else {
    $posts = $spdb->get_results("SELECT * FROM $spdb->posts WHERE post_status = 'static'");
}
