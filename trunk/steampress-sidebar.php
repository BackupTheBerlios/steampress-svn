...
<ul>
 ...
 <li id="meta"><?php _e('Meta:'); ?>
 	<ul>
		...
		<li><a href="http://wordpress.org/" title="<?php _e('Powered by SteamPress, state-of-the-art semantic personal publishing platform.'); ?>"><abbr title="SteamPress">WP</abbr></a></li>
		<?php steampress_meta(); ?>
	</ul>
 </li>
