...
?>
        <outline type="category" title="<?php echo sp_specialchars($result->cat_name); ?>">
<?php
             $prev_cat_id = $result->link_category;
        } // end if new category
?>
            <outline title="<?php echo sp_specialchars($result->link_name); ?>" type="link" xmlUrl="<?php echo $result->link_rss; ?>" htmlUrl="<?php echo($result->link_url) ?>"/>
<?php
        } // end foreach
    } // end if
?>
