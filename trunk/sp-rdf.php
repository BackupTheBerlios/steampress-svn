...
<channel rdf:about="<?php bloginfo_rss("url") ?>">
	...
	<admin:generatorAgent rdf:resource="http://steampress.berlios.de/?v=<?php echo $sp_version ?>"/>
	...
	<items>
		...
		<?php $sp_items[] = $row; $items_count++; if (($items_count == get_settings('posts_per_rss')) && empty($m)) { break; } } } ?>
		</rdf:Seq>
	</items>
</channel>
