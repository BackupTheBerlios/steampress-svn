...
define('RSS', 'RSS');
define('ATOM', 'Atom');
define('MAGPIE_USER_AGENT', 'SteamPress/' . $sp_version);
...
class RSSCache {
	var $BASE_CACHE = 'sp-content/cache';	// where the cache files are stored
...
\*=======================================================================*/
	function set ($url, $rss) {
		...
		if ( !$spdb->get_var("SELECT option_name FROM $spdb->options WHERE option_name = '$cache_option'") )
			add_option($cache_option, '', '', 'no');
		if ( !$spdb->get_var("SELECT option_name FROM $spdb->options WHERE option_name = '$cache_timestamp'") )
