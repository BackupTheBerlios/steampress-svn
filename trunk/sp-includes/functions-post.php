...
function sp_new_comment($commentdata) {
	...
	if ( $lasttime = $spdb->get_var("SELECT comment_date FROM $spdb->comments WHERE comment_author_IP = '$user_ip' ORDER BY comment_date DESC LIMIT 1") ) {
	...
	if ( get_option('comments_notify') )
		sp_notify_postauthor($spdb->insert_id, $comment_type);
