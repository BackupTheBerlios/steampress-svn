...
require(ABSPATH . 'steampress-includes/version.php');

# Translation of invalid Unicode references range to valid range
$steampress_htmltranswinuni = array(
	'&#128;' => '&#8364;', // the Euro sign
	'&#129;' => '',
...
$steampress_macIE_correction['in'] = array(
...
$steampress_macIE_correction['out'] = array(
...
$steampress_gecko_correction['in'] = array(
	'/\‘/', '/\’/', '/\“/', '/\”/',
	'/\•/', '/\–/', '/\—/', '/\Ω/',
	'/\β/', '/\γ/', '/\θ/', '/\λ/',
	'/\π/', '/\′/', '/\″/', '/\�',
...
$steampress_gecko_correction['out'] = array(
...
if (!isset($steampresssmiliestrans))
{
	$steampresssmiliestrans = array(
		' :)'		=> 'icon_smile.gif',
		' :D'		=> 'icon_biggrin.gif',
		' :-D'	   => 'icon_biggrin.gif',
...
uksort($steampresssmiliestrans, 'smiliescmp');

// generates smilies' search & replace arrays
foreach($steampresssmiliestrans as $smiley => $img)
{
	$steampress_smiliessearch[] = $smiley;
	$smiley_masked = htmlspecialchars( trim($smiley) , ENT_QUOTES);
	$steampress_smiliesreplace[] = " <img src='" . get_settings('siteurl') . "/steampress-images/smilies/$img' alt='$smiley_masked' class='steampress-smiley' /> ";
}
