...
{
	$posts = $steampressdb->get_results("SELECT * FROM $steampressdb->posts WHERE post_status = 'static' AND post_author = $user_ID");
}
else
{
	$posts = $steampressdb->get_results("SELECT * FROM $steampressdb->posts WHERE post_status = 'static'");
}
